...
# Enabling the service catalog coming in 3.6
...
openshift_hosted_logging_namespace=logging
openshift_hosted_logging_use_ops=false
openshift_hosted_logging_master_public_url=https://${HOSTNAME}:8443
openshift_hosted_logging_es_cluster_size=1
openshift_hosted_logging_es_pvc_size=5G
openshift_hosted_logging_es_memory_limit=2G
openshift_hosted_logging_es_nodeselector={"region":"infra"}
openshift_hosted_logging_kibana_hostname=kibana.${ROUTEREXTIP}.nip.io
